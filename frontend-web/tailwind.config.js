...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        card: '0 4px 6px -1px rgba(14, 165, 233, 0.07), 0 2px 4px -1px rgba(14, 165, 233, 0.06)',
        'card-hover': '0 20px 40px -12px rgba(14, 165, 233, 0.25)',
      ...
      animation: {
        ...
        bounce_slow: 'bounce 3s infinite',
